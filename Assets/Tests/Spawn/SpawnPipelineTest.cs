...
public class SpawnPipelineTest
{
    ...
    public void PipelineSpawnDestroyActivation()
    {
        ...
        ev.payload = new BaggagePayload().Add(new SpawnPipelineBaggage(typeof(TestPipeline)));
        ...
        Assert.AreSame(EcsStatic.GetPool<ECSpawnPipeline>().Get(ent).pipeline, SpawnPipelineIdService.GetPipeline(typeof(TestPipeline)));
